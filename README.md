...
[Go to the Netlify template](https://github.com/netlify-templates/next-starter-jamstack)

## Quick log of steps I've taken

1. Make main branch
2. Update .tech URL domain in Netlify to connect to new repo
